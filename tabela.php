...
if(isset($_GET['cadastrar'])){
 ...
 $sql = "INSERT INTO Aluno VALUES('$nome',$rg,'$orgao','$cpf','$tel','$email','$curso','$matricula','$endereco','$numero','$bairro','$municipio','$cep')";
...
if(isset($_GET['update'])){
    ...
    $cep = $_GET['cep'];
      ...
      ##codigo sql
    $sql = "UPDATE  Aluno SET nome= :nome, rg= :rg , orgao= :orgao,cpf= :cpf, telefone= :telefone, email= :email, curso= :curso, matricula= :matricula, endereco= :endereco, 
